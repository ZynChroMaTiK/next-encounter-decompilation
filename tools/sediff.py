...
CLASS_MAP = {
    ...
    4220: ("Bouncer", EXACT, ""),
    4230: (None, NONE, "unidentified in NE too"),
    4240: ("DestroyableArchitecture", EXACT, ""),
    4260: (None, NONE, "'Arrow' pickup; purpose unclear"),
    4270: (None, NONE, "'LockDown'; purpose unclear"),
    4280: ("Teleport", LIKELY, "WarpPlayers = mass teleport"),
    4310: ("ParticlesHolder", EXACT, ""),
    4320: (None, NONE, "CTF flag; SE1 has no flag entity"),
    4330: (None, NONE, "par time for scoring"),
    4340: (None, NONE, "FMV playback"),
    5000: ("EnemyBase", EXACT, "the template; the creature itself is separate"),
    5010: ("Light", EXACT, ""),
    5020: (None, NONE, "unidentified in NE too"),
